  ...
  if (text.includes('ssat') || text.includes('score') || text.includes('math') || text.includes('vocab')) {
    return {
      ...
      sceneScript: {
        ...
        scene2Body: '1. Master Verbal Analogies with Bridge Sentences\n2. Skip Unsure Math Questions (+0 vs -0.25)\n3. Practice 50+ Timed Passages on PrepPath AI',
        scene3Cta: '🎓 Tap link in bio to predict your SSAT score on PrepPath.ai!',
      },
    };
    ...
    return {
      ...
      sceneScript: {
        ...
        scene2Body: '❌ BEFORE: "I am a very hardworking student."\n\n✅ AFTER: "Surmounting 40-hr robotics challenges taught me..."',
        scene3Cta: '📲 Get your essay reviewed line-by-line on PrepPath AI!',
      },
    };
    ...
    return {
      ...
      sceneScript: {
        ...
        scene2Body: '1. "Why our school specifically?"\n2. "Tell me about a setback you overcame."\n3. "How do you handle different perspectives?"',
        scene3Cta: '🔥 Practice AI mock interviews live on PrepPath.ai!',
      },
    };
  } else {
